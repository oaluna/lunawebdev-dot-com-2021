      ...
      <div
        ...
        <div
          ...
          <a
            ...
            className='socialItem'>
            <img src="https://cdn3.iconfinder.com/data/icons/social-network-round-gloss-shine/512/GitHub_Social-Network-Communicate-Page-Curl-Effect-Circle-Glossy-Shadow-Shine.png" alt="Logo, social, github icon" style={{width: '32px', height: '32px'}} />
          </a>
        </div>
        <div className='aboutBody' style={{ width: '90vw' }}>
          <div
            ...
            <a
              style={{ zIndex: 25 }}
              href={aboutMeData.portfolioLink}>
              <div
        ...
        <div className='lottiefilesContainer' style={{ position: 'absolute',
              zIndex: 0, marginTop: '20vh', marginLeft: '50vw' }}>
          <lottie-player
